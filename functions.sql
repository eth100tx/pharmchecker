-- PharmChecker Database Functions
-- This script creates the specialized functions needed for PharmChecker
...
-- Function to find pharmacy/search pairs that need scoring
